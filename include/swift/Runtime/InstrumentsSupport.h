...
extern "C" void (*_swift_retain)(HeapObject *object) RUNTIME_CC;
extern "C" void (*_swift_retain_n)(HeapObject *object, uint32_t n) RUNTIME_CC;
extern "C" HeapObject *(*_swift_tryRetain)(HeapObject *object) RUNTIME_CC;
extern "C" bool (*_swift_isDeallocating)(HeapObject *object);
extern "C" void (*_swift_release)(HeapObject *object) RUNTIME_CC;
extern "C" void (*_swift_release_n)(HeapObject *object, uint32_t n) RUNTIME_CC;
