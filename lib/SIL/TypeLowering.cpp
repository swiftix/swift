...
namespace {
  ...
  public:
    ...
    void emitRetainValue(SILBuilder &B, SILLocation loc,
      ...
      B.createRetainValue(loc, aggValue, false);
    }
  ...
  public:
    ...
    void emitRetainValue(SILBuilder &B, SILLocation loc,
                       SILValue value) const override {
      B.createRetainValue(loc, value, false);
    }
  ...
  public:
    ...
    void emitRetainValue(SILBuilder &B, SILLocation loc,
      ...
      if (!isa<FunctionRefInst>(value))
        B.createStrongRetain(loc, value, false);
    }
  ...
  public:
    ...
    void emitRetainValue(SILBuilder &B, SILLocation loc,
                       SILValue value) const override {
      B.createUnownedRetain(loc, value, false);
    }

    void emitReleaseValue(SILBuilder &B, SILLocation loc,
                          SILValue value) const override {
      B.createUnownedRelease(loc, value, false);
    }
  };
