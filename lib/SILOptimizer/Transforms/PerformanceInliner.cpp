...
bool SILPerformanceInliner::isProfitableToInline(FullApplySite AI,
  ...
  // Inlining a generic function is more beneficial.
  if (IsGeneric) {
    // TODO: Should this benefit depend on the number of
    // substitutions or conformances?
    BaseBenefit = BaseBenefit * 2 / 2;
    //BaseBenefit = 0;
  }
