...
public:
  ...
  CallInst *createUnknownReleaseN(Value *V, uint32_t n, CallInst *OrigI) {
    // Cast just to make sure we have the right object type.
    V = B.CreatePointerCast(V, getObjectPtrTy());
    CallInst *CI = CreateCall(getUnknownReleaseN(OrigI), {V, getIntConstant(n)});
    CI->setTailCall(true);
    return CI;
  }
...
private:
  ...
  Constant *getRetain(CallInst *OrigI) {
    ...
    Retain = getWrapperFn(getModule(),
                           ...
                           isNonAtomic(OrigI)? SWIFT_RT_ENTRY_REF_AS_STR(swift_nonatomic_retain) : SWIFT_RT_ENTRY_REF_AS_STR(swift_retain),
  ...
  Constant *getRelease(CallInst *OrigI) {
    ...
    Release = getWrapperFn(getModule(),
                           ...
                           isNonAtomic(OrigI) ? SWIFT_RT_ENTRY_REF_AS_STR(swift_nonatomic_release):  SWIFT_RT_ENTRY_REF_AS_STR(swift_release),
                           RegisterPreservingCC,
                           {VoidTy},
                           {ObjectPtrTy},
                           {NoUnwind});
  ...
  Constant *getRetainN(CallInst *OrigI) {
    ...
    RetainN = getWrapperFn(getModule(),
                           ...
                           isNonAtomic(OrigI)? SWIFT_RT_ENTRY_REF_AS_STR(swift_nonatomic_retain_n) : SWIFT_RT_ENTRY_REF_AS_STR(swift_retain_n),
                           RegisterPreservingCC,
                           {VoidTy},
                           {ObjectPtrTy, Int32Ty},
                           {NoUnwind});
  ...
  Constant *getReleaseN(CallInst *OrigI) {
    ...
    ReleaseN = getWrapperFn(getModule(),
                            ...
                            isNonAtomic(OrigI)? SWIFT_RT_ENTRY_REF_AS_STR(swift_nonatomic_release_n) : SWIFT_RT_ENTRY_REF_AS_STR(swift_release_n),
                            RegisterPreservingCC,
                            {VoidTy},
                            {ObjectPtrTy, Int32Ty},
                            {NoUnwind});
  ...
  Constant *getUnknownRetainN(CallInst *OrigI) {
    ...
    UnknownRetainN = getRuntimeFn(getModule(),
                                  cache,
                                  isNonAtomic(OrigI)? "swift_nonatomic_unknownRetain_n":"swift_unknownRetain_n",
                                  DefaultCC,
                                  {VoidTy},
                                  {ObjectPtrTy, Int32Ty},
                                  {NoUnwind});
  ...
  Constant *getUnknownReleaseN(CallInst *OrigI) {
    ...
    UnknownReleaseN = getRuntimeFn(getModule(),
                                   cache,
                                   isNonAtomic(OrigI)? "swift_nonatomic_unknownRelease_n": "swift_unknownRelease_n",
                                   DefaultCC,
                                   {VoidTy},
                                   {ObjectPtrTy, Int32Ty},
                                   {NoUnwind});
  ...
  Constant *getBridgeRetainN(CallInst *OrigI) {
    ...
    BridgeRetainN = getRuntimeFn(getModule(),
                                 cache,
                                 isNonAtomic(OrigI)? "swift_nonatomic_bridgeObjectRetain_n" : "swift_bridgeObjectRetain_n",
                                 DefaultCC,
                                 {BridgeObjectPtrTy},
  ...
  Constant *getBridgeReleaseN(CallInst *OrigI) {
    ...
    BridgeReleaseN = getRuntimeFn(getModule(),
                                  cache,
                                  isNonAtomic(OrigI)? "swift_nonatomic_bridgeObjectRelease_n" : "swift_bridgeObjectRelease_n",
                                  DefaultCC,
                                  {VoidTy},
                                  {BridgeObjectPtrTy, Int32Ty},
                                  {NoUnwind});
