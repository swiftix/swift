...
// Prefix used by auto-generated wrappers.
#define SWIFT_RT_WRAPPER_PREFIX "__rt_"
#define STR(X) #X
#define SWIFT_RT_WRAPPER_NAME(Name) STR(__rt_##Name)
...
#if defined(SWIFT_RT_WRAPPER_PREFIX)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_retain), RT_Retain)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_retain_n), RT_RetainN)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_release), RT_Release)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_release_n), RT_ReleaseN)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_allocObject), RT_AllocObject)
    .Case(SWIFT_RT_WRAPPER_NAME(objc_release), RT_ObjCRelease)
    .Case(SWIFT_RT_WRAPPER_NAME(objc_retain), RT_ObjCRetain)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_retainUnowned), RT_RetainUnowned)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_checkUnowned), RT_CheckUnowned)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_bridgeObjectRetain), RT_BridgeRetain)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_bridgeObjectRetain_n), RT_BridgeRetainN)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_bridgeObjectRelease), RT_BridgeRelease)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_bridgeObjectRelease_n), RT_BridgeReleaseN)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_unknownRetain), RT_UnknownRetain)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_unknownRetain_n), RT_UnknownRetainN)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_unknownRelease), RT_UnknownRelease)
    .Case(SWIFT_RT_WRAPPER_NAME(swift_unknownRelease_n), RT_UnknownReleaseN)
#endif
    .Default(RT_Unknown);
}
